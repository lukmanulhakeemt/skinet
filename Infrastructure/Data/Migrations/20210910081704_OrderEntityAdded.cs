    ...
    public partial class OrderEntityAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DelveryMethods", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DaliveryMethodId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_DelveryMethods_DaliveryMethodId",
                        column: x => x.DaliveryMethodId,
                        principalTable: "DelveryMethods",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_DaliveryMethodId",
                table: "Orders",
                column: "DaliveryMethodId");
        }
